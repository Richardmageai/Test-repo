...
def load_fake_054_data(**kwargs):
    rng = random.Random('agent_dev_seed_pipeline_055:load_fake_055_1')
    rows = [
        {
            'customer_id': customer_id,
            'pipeline_uuid': 'agent_dev_seed_pipeline_055',
    ...
    df.to_json(output_dir / 'load_fake_055_1.jsonl', orient='records', lines=True)
    return df
